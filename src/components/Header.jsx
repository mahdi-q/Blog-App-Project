...
function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-10 mb-10 border-b border-b-secondary-300 bg-inherit shadow-md transition-all duration-200 ${isLoading ? "opacity-70 blur-sm" : "opacity-100 blur-none"}`}
    >
